...
# Claude Hooks Remote Installer
#
# This script downloads and installs the Claude Hooks
# Usage: curl -fsSL https://raw.githubusercontent.com/anthoai97/personal-claude-libs/master/install.sh | bash

set -euo pipefail

# Configuration
REPO_OWNER="anthoai97"
...
print_color "$BLUE" "╔═══════════════════════════════════════════════╗"
print_color "$BLUE" "║                                               ║"
print_color "$BLUE" "║         🚀 Claude Hooks Installer             ║"
print_color "$BLUE" "║                                               ║"
print_color "$BLUE" "╚═══════════════════════════════════════════════╝"
echo
...
# Download framework
print_color "$CYAN" "📥 Downloading Claude Hooks..."
...
if [ -f "$TEMP_DIR/status" ] && [ "$(cat "$TEMP_DIR/status")" = "DOWNLOAD_FAILED" ]; then
    print_color "$RED" "❌ Failed to download"
    ...
    echo "  3. Try manual installation (git clone)"
    exit 1
fi
...
if [ -f "$TEMP_DIR/extract_status" ] && [ "$(cat "$TEMP_DIR/extract_status")" = "EXTRACT_FAILED" ]; then
    print_color "$RED" "❌ Failed to extract"
...
if [ ! -d "$EXTRACT_DIR" ]; then
    print_color "$RED" "❌ Could not find extracted directory"
    exit 1
fi
...
print_color "$CYAN" "🔧 Starting hooks setup..."
print_color "$CYAN" "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo
...
echo
print_color "$GREEN" "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
print_color "$GREEN" "🎉 Claude Hooks installation complete!"
print_color "$GREEN" "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
